...
vim.api.nvim_buf_set_keymap(0, 'n', 'zj', ':lua require("user_functions.navigate_folds").NavigateFold("j")<CR>', { noremap = true, silent = true })
vim.api.nvim_buf_set_keymap(0, 'n', 'zk', ':lua require("user_functions.navigate_folds").NavigateFold("k")<CR>', { noremap = true, silent = true })
  ...
  settings = {
    yaml = {
      schemas = {
        ...
        ['https://json.schemastore.org/helmfile.json'] = '*/templates/**.{yml,yaml}',
      },
    },
  },
}
